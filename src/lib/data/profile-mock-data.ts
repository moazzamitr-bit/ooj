...
export function getAlbertBullets(firstName: string) {
  return [
    { text: `سلام ${firstName}! 👋` },
    { text: "من آلبرتو، مشاور هوشمند شخصی توام!" },
    { text: "یعنی از امروز، دیگه تنها درس نمی‌خونی!" },
    { text: "هر سوالی داری، فوری جوابت رو می‌دم!" },
    { text: "سخت‌ترین مسئله‌ها رو برات حل می‌کنم!" },
    { text: "برنامه روزانه مخصوص خودت می‌چینم!" },
    { text: "فلش‌کارت اختصاصی برات می‌سازم!" },
    { text: "و از همه مهم‌تر..." },
    { text: "پیشرفتت رو هر هفته اندازه می‌گیرم!" },
    { text: "جایگاهت رو با بقیه مقایسه می‌کنم!" },
    { text: "رتبه کنکورت رو هم تخمین می‌زنم!" },
    { text: "آماده‌ای باهم شروع کنیم؟ 🎉" },
  ];
}
