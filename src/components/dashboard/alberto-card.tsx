  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="z-10 m-3 flex min-h-0 min-w-0 flex-1 flex-col rounded-2xl bg-white p-5 shadow-[0_8px_30px_rgb(17_26_76_0.06)] md:m-4 md:p-6">
            <div className="mb-3 flex items-center justify-start gap-3 md:mb-4">
            ...
            <ul className="flex flex-1 flex-col justify-center gap-2 overflow-y-auto py-1 md:gap-2.5 md:py-1">
              {bullets.map((item) => (
                <li
                  key={item.text}
                  className="text-[15px] font-medium leading-7 text-primary-deep md:text-base md:leading-8"
                >
            ...
            <button
              ...
              className="mt-4 flex h-14 w-full shrink-0 items-center justify-center gap-2.5 rounded-full bg-gradient-to-l from-primary to-electric-blue px-4 text-lg font-bold text-white shadow-lg shadow-primary/25 transition hover:opacity-95 md:mt-5 md:h-14 md:text-xl"
            >
          ...
          <div className="relative order-first h-52 w-full shrink-0 overflow-hidden bg-[#F3F0FF] md:order-none md:h-full md:min-h-0 md:w-[36%]">
            <Image
              src={albertoPortrait}
