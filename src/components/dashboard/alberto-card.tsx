  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="z-10 m-3 flex min-h-0 min-w-0 flex-1 flex-col rounded-2xl bg-white p-4 shadow-[0_8px_30px_rgb(17_26_76_0.06)] md:m-4 md:p-5">
            <div className="mb-3 flex items-center justify-end gap-2">
              <h2 className="text-base font-extrabold text-primary-deep">آلبرتو</h2>
            ...
            <ul className="flex-1 space-y-2 overflow-y-auto">
              {bullets.map((item) => (
                <li
                  key={item.text}
                  className="text-xs leading-6 text-primary-deep md:text-[13px] md:leading-6"
                >
            ...
            <button
              ...
              className="mt-4 flex h-11 w-full shrink-0 items-center justify-center gap-2 rounded-full bg-gradient-to-l from-primary to-electric-blue text-sm font-bold text-white shadow-lg shadow-primary/25 transition hover:opacity-95"
            >
